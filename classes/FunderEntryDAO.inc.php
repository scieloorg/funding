...
/**
 * @file classes/FunderEntryDAO.inc.php
 *
 * Copyright (c) 2014-2017 Simon Fraser University
 * Copyright (c) 2000-2017 John Willinsky
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * @class FunderEntryDAO
 * @ingroup submission
 * @see Submission
 *
 * @brief Operations for retrieving and modifying a submission's funders
 */

import('plugins.generic.fundRef.classes.SubmissionFunder');
import('lib.pkp.classes.controlledVocab.ControlledVocabEntryDAO');

class FunderEntryDAO extends ControlledVocabEntryDAO {
	/**
	 * Constructor
	 */
